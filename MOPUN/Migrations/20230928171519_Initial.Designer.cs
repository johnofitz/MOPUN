...
namespace MOPUN.Migrations
{
    ...
    [Migration("20230928171519_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOPUN.Models.TripTicketCreateDTO", b =>
                {
                    b.Property<int>("TripId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TripTicketCreateDTO");
                });

            modelBuilder.Entity("MOPUN.Models.TripTicketRequest", b =>
                {
                    b.Property<int>("TripTicketDTOTripId")
                        .HasColumnType("int");

                    b.HasIndex("TripTicketDTOTripId");

                    b.ToTable("TripTicketRequest");
                });
            ...
            modelBuilder.Entity("MOPUN.Models.TripTicketRequest", b =>
                {
                    b.HasOne("MOPUN.Models.TripTicketCreateDTO", "TripTicketDTO")
                        .WithMany()
                        .HasForeignKey("TripTicketDTOTripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TripTicketDTO");
                });
